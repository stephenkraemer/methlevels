...
# see screenshot test-data/egf-region_igv-screenshot.png
...
def test_read_gencode_df(gtf_fp):
    ...
    # gencode_df.to_pickle('/home/kraemers/projects/methlevels/tests/test-data/gencode_mm10_egf_region_bed-like-df.p')
